...
const char* ssid = "Curtin";
const char* password = "9786820998";
...
#define Strip_Pin 13
#define LED_Count 8
Adafruit_NeoPixel strip(LED_Count, Strip_Pin, NEO_GRB + NEO_KHZ800); // Define Neopixel Strip characteristics
...
const char EllenLiftNames[EllenLiftCount] = {'Green Mountain Express Quad', 'North Ridge Express Quad', 'Summit Quad', 'Sunshine Quad', 'Tommy\'s Toy'};
